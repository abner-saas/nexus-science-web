      ...
      <main id="conteudo">
          ...
          <div className="mx-auto grid max-w-5xl items-start gap-10 px-4 py-10 md:grid-cols-[1.05fr_0.95fr] md:px-6 md:py-14">
            <div>
              ...
              <p className="mt-4 max-w-md text-[15px] leading-relaxed text-black/65">
                Você treina com prescrição, registra o que fez e como chegou, e acompanha
                avaliação e mensalidade no mesmo login. O Abner vê isso no painel da
                consultoria. Acesso ao app só depois que vocês fecham o plano — não há
                matrícula automática neste site.
              </p>
              <div className="mt-7 flex max-w-sm flex-col gap-3">
                {wa ? (
                  <a href={wa} className="ns-btn-primary h-11 justify-center no-underline">
            ...
            <div className="overflow-hidden rounded-2xl border border-line shadow-card">
              <StudentAppPreview greeting="Prévia do app do aluno" />
            </div>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-5xl px-4 py-12 md:px-6">
          ...
          <p className="mt-2 max-w-2xl text-sm leading-relaxed text-black/60">
            A tela à direita (e a prévia completa) replica o app do aluno: as quatro
            seções de baixo são as mesmas do produto. Os números são de demonstração —
            a ficha real é a que o Abner atribuir ao seu cadastro.
          </p>
          <dl className="mt-8 divide-y divide-line border-y border-line bg-white">
            {DAY_TO_DAY.map((item) => (
              <div key={item.title} className="grid gap-2 px-4 py-5 md:grid-cols-[200px_1fr] md:gap-8">
        ...
        <section className="border-y border-line bg-white">
          <div className="mx-auto max-w-5xl px-4 py-12 md:px-6">
            ...
            <p className="mt-2 max-w-2xl text-sm leading-relaxed text-black/60">
              A plataforma é da consultoria, não uma loja de software. Cadastro, plano e
              liberação passam pelo Abner.
            </p>
        ...
        <section className="mx-auto max-w-5xl px-4 py-12 md:px-6">
          <div className="ns-card p-6 md:p-8">
            ...
            <p className="mt-2 max-w-xl text-sm leading-relaxed text-black/60">
              Entre com o e-mail do cadastro ou Google do mesmo endereço. Equipe da
              consultoria usa o painel (CRM, treinos, financeiro) — não esta página.
            </p>
            <div className="mt-5 flex flex-wrap gap-3">
              <Link href="/login?as=aluno" className="ns-btn-primary no-underline">
                Entrar no app do aluno
              </Link>
              <Link href="/login" className="ns-btn-secondary no-underline">
                Painel da equipe
              </Link>
            </div>
          </div>
